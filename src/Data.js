...
const skill = [
  {
    ...
    name: "react",
    skill:
      "현재 포트폴리오는 리액트로 구현되었으며, 데이터(props)를 입력받아 View(state) 상태에 따라 React Hooks을 사용하여 컴포넌트를 활용 할수 있습니다. ",
  },
  {
    id: 2,
    name: "html",
    skill:
      "에이전시에서 개발한 경험으로 웹접근성을 고려하며 웹표준을 준수한 시멘틱 태그사용과 크로스 브라우징 마크업이 가능합니다. 또한 SEO를 위하여 메타태그 설정등 경험이 있으며 정보보안에 대한 SSL 이해도가 있습니다.",
  },
  {
    id: 3,
    name: "css3",
    skill:
      "다양한 레이아웃과 애니메이션을 구현할 수 있으며 최신기술인 flex, grid등을 활용합니다. 전처리기인 sass를 사용하여 포토폴리오를 제작하였습니다.",
  },
  {
    id: 4,
    name: "javascript",
    skill:
      "Vanilla JS의 기본개념인 변수, 조건문, 반복문, 배열, 함수를 활영하여 현업에서 기능을 구현하였습니다.",
  },
  {
    id: 5,
    name: "jquery",
    skill:
      "뷰포트에 대한 이해 및 jquery 기반의 라이브러리를 사용하여 현업에서 웹페이지 UI에 적용하였습니다.",
  },
  {
    id: 6,
    name: "php",
    skill:
      "php 용어에 대한 이해도가 있으면 php로 개발 된 그누보드, 영카트 작업시 변수 선언, 조건문 작성등을 하였습니다.",
  },
  {
    id: 7,
    name: "mysql",
    skill:
      "스마트콘텐츠 교육 당시 mysql을 수강하였으며 DB에 대한 기초지식 습득 및 질의문에 대해 이해할 수 있습니다.",
  },

  {
    ...
    name: "java",
    skill:
      "자바(JAVA)프로그래밍 교육을 수강하며 기본 문법 및 기초지식을 습득하였고 java 기반 웹사이트를 퍼블리싱 한 경험이 있습니다.",
  },
  {
    id: 9,
    name: "redux",
    skill:
      "투두리스트 제작시 리덕스를 사용한 경험이 있습니다. 리덕스를 통해 복잡한 상태관리를 효율적으로 할 수 있도록 지속적으로 공부하고 있습니다.",
  },
  {
    id: 10,
    name: "git",
    skill:
      "백업 및 협업이 가장 중요하다고 생각하여 개인 프로젝트를 깃으로 버전관리하고 있습니다. SVN을 현업에서 경험하였으며 효율적으로 깃을 관리하기 위해 지속적으로 공부하고 있습니다.",
  },
  {
    id: 11,
    name: "photoshop",
  ...
  },
  {
    ...
    name: "figma",
    skill:
      "피그마를 이용하여 레이아웃 배치를 경험하였으며 현업에서 작업한 경험이 있습니다.",
  },
];
